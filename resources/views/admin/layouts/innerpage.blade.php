...
<html lang="en" class="no-js">
  ...
  <head>
    ...
    <link rel="stylesheet" href="{{ asset("/admin/clip-one/assets/plugins/iCheck/skins/all.css") }}">
    ...
    <link rel="stylesheet" href="{{ asset("/admin/clip-one/assets/plugins/fullcalendar/fullcalendar/fullcalendar.css") }}">
    <link rel="stylesheet" type="text/css" href="{{ asset("/admin/clip-one/assets/plugins/select2/select2.css") }}" />
    <link rel="stylesheet" href="{{ asset("/admin/clip-one/assets/plugins/DataTables/media/css/DT_bootstrap.css") }}" />
  ...
  <body>
    ...
    <script src="{{asset("/admin/clip-one/assets/plugins/perfect-scrollbar/src/jquery.mousewheel.js")}}"></script>
    <script src="{{asset("/admin/clip-one/assets/plugins/perfect-scrollbar/src/perfect-scrollbar.js")}}"></script>
    <script src="{{asset("/admin/clip-one/assets/plugins/select2/select2.min.js")}}"></script>
    <script src="{{asset("/admin/clip-one/assets/plugins/jquery-cookie/jquery.cookie.js")}}"></script>
   
    <script src="{{asset("/admin/clip-one/assets/js/main.js")}}"></script>
    <script src="{{ asset("/admin/clip-one/assets/js/bootstrapValidator.js") }}"></script>

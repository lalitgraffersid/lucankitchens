          ...
          <fieldset>
            ...
            <div class="form-group">
              <span class="input-icon">
                <input type="hidden" value="{{$user->id}}" class="form-control" name="id" placeholder="id">             
            </div>
            ...
            <div class="form-group form-actions">
              <span class="input-icon">
                ...
                {!! Form::input('password', 'current_password', Cookie::get('pass'), array('id' => 'current_password', 'name' => 'current_password', 'placeholder' => 'Current Password', 'class' => 'form-control', 'required' => 'required')) !!}

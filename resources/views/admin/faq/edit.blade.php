    ...
    <!-- start: MAIN CONTAINER -->
        ...
        <div class="container" ng-controller="cmsController">
          ...
          <div class="row">
           ...
           {!! Form::open(array('route' => 'faq.update','method'=>'POST', 'class' => 'form-horizontal', 'id' => 'faqAdd', 'name' => 'faqAdd', 'files' => true, 'enctype' => 'multipart/form-data')) !!} 

                    <input type="hidden" name="id" id="id" value="{{$faqDetail->id}}">
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-sm-9">
                        <input type="text" name="faq_title" id="faq_title" placeholder="Title"  class="form-control" value="{{$faqDetail->faq_title}}" required>
                      </div>
                    </div>
                    <div class="form-group">
                      ...
                      <div class="col-sm-9">
                        <textarea id="faq_description" name="faq_description" rows="7" class="form-control ckeditor" placeholder="Write your message.." required="required">{{$faqDetail->faq_description}}</textarea>
                      </div>
                    </div>
                    <div class="form-group">

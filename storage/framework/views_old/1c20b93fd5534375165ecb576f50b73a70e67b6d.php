...
<!--inner wrapper start-->
      <div class="inner_wrapper genpad">
         <div class="container">
            <div class="row">
               <div class="col-md-12">
                  <h1><span>Wardrobes</span></h1>
               </div>
               
               <div class="col-md-4 wow fadeInUp">
                  <div class="gen_box">
                     <img src="<?php echo e(asset('/frontend/images/wardrobes_01.jpg')); ?>" alt="">
                     <h6>Wardrobes</h6>
                  </div>
               </div>
               ...
               <div class="col-md-4 wow fadeInUp">
                  <div class="gen_box">
                     <img src="<?php echo e(asset('/frontend/images/wardrobes_02.jpg')); ?>" alt="">
                     <h6>Wardrobes</h6>
                  </div>
               </div>
               ...
               <div class="col-md-4 wow fadeInUp">
                  <div class="gen_box">
                     <img src="<?php echo e(asset('/frontend/images/wardrobes_03.jpg')); ?>" alt="">
                     <h6>Wardrobes</h6>
                  </div>
               </div>
               ...
               <div class="col-md-4 wow fadeInUp">
                  <div class="gen_box">
                     <img src="<?php echo e(asset('/frontend/images/wardrobes_04.jpg')); ?>" alt="">
                     <h6>Wardrobes</h6>
                  </div>
               </div>
               ...
               <div class="col-md-4 wow fadeInUp">
                  <div class="gen_box">
                     <img src="<?php echo e(asset('/frontend/images/wardrobes_05.jpg')); ?>" alt="">
                     <h6>Wardrobes</h6>
                  </div>
               </div>
               ...
               <div class="col-md-4 wow fadeInUp">
                  <div class="gen_box">
                     <img src="<?php echo e(asset('/frontend/images/wardrobes_06.jpg')); ?>" alt="">
                     <h6>Wardrobes</h6>
                  </div>
               </div>

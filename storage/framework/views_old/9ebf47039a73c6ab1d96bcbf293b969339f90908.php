    ...
    <!-- start: MAIN CONTAINER -->
        ...
        <div class="container" ng-controller="cmsController">
          ...
          <div class="row">
           ...
           <?php echo Form::open(array('route' => 'teams.save','method'=>'POST', 'class' => 'form-horizontal', 'id' => 'teamsAdd', 'name' => 'teamsAdd', 'files' => true, 'enctype' => 'multipart/form-data')); ?> 
					...
					<div class="form-group">
                      <label class="col-sm-2 control-label" for="personal_information">
                        Personal information
                      </label>
                      <div class="col-sm-9">
                        <textarea id="personal_information" name="personal_information" rows="7" class="form-control" placeholder="degination Descripotion" required="required"></textarea>
                      </div>
                    </div>
					

                    <div class="form-group">
                      <label class="col-sm-2 control-label" for="team_image">
                       Image
                      </label>
                      <div class="col-sm-9">
                        <input type="file" class="file-input" name="team_image">
                      </div>
                    </div>
					<div class="form-group">
					...
					<div class="form-group">
                      <label class="col-sm-2 control-label" for="linkedin">
                        linkedin
                      </label>
                      <div class="col-sm-9">
					...
					<div class="form-group">
                      <label class="col-sm-2 control-label" for="pinterest">
                        pinterest
                      </label>
                      <div class="col-sm-9">
                        <input type="text" name="pinterest" id="pinterest" placeholder="pinterest"  class="form-control" >
                      </div>
                    </div>
					<div class="form-group">
                      <label class="col-sm-2 control-label" for="googleplus">
                        googleplus
                      </label>
                      <div class="col-sm-9">
                        <input type="text" name="googleplus" id="googleplus" placeholder="googleplus"  class="form-control" >
                      </div>
                    </div>
                    ...
                    <a class="btn btn-green" href="<?php echo e(url('admin/team/index')); ?>">Back</a>
                      </div>
                    </div>

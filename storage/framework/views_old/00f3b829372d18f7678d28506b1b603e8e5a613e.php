...
<div class="main-navigation navbar-collapse collapse">
          ...
          <ul class="main-navigation-menu">
			...
			<!--- ################################33 -->
			<li <?php if($current_route_name == 'sales.index' || $current_route_name == 'sales.add' || $current_route_name == 'sales.edit'): ?> class="active open" <?php endif; ?>">
              ...
              <ul class="sub-menu">
                ...
                <li <?php if($current_route_name == 'sales.index'): ?> class="active" <?php endif; ?>>

                  <a href="<?php echo e(url('/admin/sale/index')); ?>">
                ...
                <li <?php if($current_route_name == 'sales.add'): ?> class="active" <?php endif; ?>>

                  <a href="<?php echo e(url('/admin/sale/add')); ?>">
			...
			<li <?php if($current_route_name == 'testimonial.index' || $current_route_name == 'testimonial.add' || $current_route_name == 'testimonial.edit'): ?> class="active open" <?php endif; ?>">
              ...
              <ul class="sub-menu">
                ...
                <li <?php if($current_route_name == 'testimonial.index'): ?> class="active" <?php endif; ?>>

                  <a href="<?php echo e(url('/admin/testimonial/index')); ?>">
                ...
                <li <?php if($current_route_name == 'testimonial.add'): ?> class="active" <?php endif; ?>>

                  <a href="<?php echo e(url('/admin/testimonial/add')); ?>">

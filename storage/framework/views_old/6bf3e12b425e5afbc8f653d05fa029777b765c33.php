...
<html lang="en" class="no-js">
  ...
  <body class="login example1">
    <div class="main-login col-md-4 col-md-offset-4 col-sm-6 col-sm-offset-3">
      ...
      <?php endif; ?>
        <?php echo e(Form::open(array('url' => 'admin/dologin'))); ?>
          ...
          <fieldset>
            ...
            <div class="form-group form-actions">
              <span class="input-icon">
                ...
                <?php echo Form::input('password', 'password', Cookie::get('pass'), array('id' => 'password', 'name' => 'password', 'placeholder' => 'Password', 'class' => 'form-control', 'required' => 'required')); ?>
        ...
        <a href="<?php echo e(url('admin/viewforgotpassword')); ?>">
          <i class="clip-exit"></i>
          &nbsp;Forgot Password
        </a>
      </div>

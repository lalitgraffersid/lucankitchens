                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td>
                          ...
                          <a href="<?php echo \URL::route('cms.delete',$cms->id); ?>" onclick="return confirm('Are you sure you want to delete cms?')" class="btn btn-xs btn-bricky tooltips" data-placement="top" data-original-title="Remove"><i class="fa fa-times fa fa-white"></i></a>
                        </td>

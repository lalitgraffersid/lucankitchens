         ...
         <div class="container">
            <div class="row">
               ...
               <div class="col-md-12">
                  <div class="gallery_list">
                     <div class="button-group filter-button-group">
                        ...
                        <button data-filter=".Kitchen">Kitchens</button>
                        <button data-filter=".Wardrobe">Wardrobes</button>
                       
                        <button data-filter=".Interior">Interior</button> 

                        <button data-filter=".Bespokedoor">Bespoke Door</button>
                        <button data-filter=".Radiatorcover">Radiator Cover</button>                  
                     </div>
                  </div>
              ...
              <?php $__currentLoopData = $project; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $p): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                     <div class="box <?php echo e($p->type); ?>">

         ...
         <div class="container">
            <div class="row">
               <div class="col-md-6 wow fadeInUp">
                  <div class="abt_pic">
                     <img src="<?php echo e(asset('/frontend/images/about_thum_01.jpg')); ?>" alt="">
                     <img src="<?php echo e(asset('/frontend/images/about_sm_thum_01.jpg')); ?>" alt="" class="smthum">
                  </div>
               </div>
               <div class="col-md-6 wow fadeInUp">
      ...
      <div class="project_wrapper genpad">
         <div class="container">
            <div class="row">
               ...
               <div class="col-md-4 wow fadeInUp">
                  <div class="box">
                     <img src="<?php echo e(asset('/frontend/images/project_01.jpg')); ?>" alt="">
                     <div class="txt">
                        <h6>Kitchens</h6>
               ...
               <div class="col-md-4 wow fadeInUp">
                  <div class="box">
                     <img src="<?php echo e(asset('/frontend/images/project_02.jpg')); ?>" alt="">
                     <div class="txt">
               ...
               <div class="col-md-4 wow fadeInUp">
                  <div class="box">
                     <img src="<?php echo e(asset('/frontend/images/project_03.jpg')); ?>" alt="">
                     <div class="txt">
                        <h6>Interiors</h6>
                        <p>eaque ipsa quae ab illo inventore veritatis et quasi architecto beatae vitae dicta sunt explicabo.</p>
                     </div>
